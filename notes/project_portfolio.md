...
- **Selected Work control/layering polish**: desktop project pills now wrap inside a contained control row for future project growth; mobile circular controls have more bottom spacing; the decorative back plates behind the screenshot/browser card are sized from the visual column so they stay balanced at desktop widths.
- **Portal image optimized**: `EL Portal` now imports `src/assets/projects/portal.jpg`, a 1200px-wide compressed JPEG generated from the original PNG. Build output dropped from ~3.1MB to ~221KB for that project image.
- **Senior copywriter pre-launch pass applied**: replaced generic/abstract lines with more concrete conversion-focused copy in Hero, Work, Services, Fit, Philosophy, and the Launch Page service description. Fixed Fit typo/backtick and softened overclaims around profit/conversion.
...
- Intro: "Three scopes. One level of attention. Whether you are launching, redesigning, or building something custom, the work starts with the same question: what does your buyer need to understand, trust, and do?"
- Launch Page: "You have an offer worth taking seriously. This gets it in front of the right people with a page built for clarity, trust, and action."
